            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-lg-9 border p-4 bg-white">
                        <h2>Produk Jasa</h2>
                        <p>Kelola Produk Jasa anda untuk mengontrol, melindungi, dan mengamankan produk</p>
                        <hr>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><a href="#"><img src="/assets/images/#.png" class="avatar" alt="Avatar"> Judul barang</a></td>                        <td>
                            <a href="#" class="settings" title="Settings" data-toggle="tooltip"></i><i class="material-icons">&#xE8B8;</i></a>
